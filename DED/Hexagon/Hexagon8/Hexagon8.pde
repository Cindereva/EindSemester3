...
void fractal(float x1, float y1,float x2, float y2,float x3, float y3,float x4, float y4,float x5, float y5,float x6, float y6, float x7, float y7,float r, float n){
    ...
    float r2 = (r/3);
     ...
     fractal(w1-x2, h1-y2, w2-x2,h2-y2,w3-x2,h3-y2,w4-x2,h4-y2,w5-x2,h5-y2,w6-x2,h6-y2,w7-x2,h7-y2,r2,1);
     fractal(w1-x2, h1+y2, w2-x2,h2+y2,w3-x2,h3+y2,w4-x2,h4+y2,w5-x2,h5+y2,w6-x2,h6+y2,w7-x2,h7+y2,r2,1);
     fractal(w1+x2, h1-y2, w2+x2,h2-y2,w3+x2,h3-y2,w4+x2,h4-y2,w5+x2,h5-y2,w6+x2,h6-y2,w7+x2,h7-y2,r2,1);
     fractal(w1+x2, h1+y2, w2+x2,h2+y2,w3+x2,h3+y2,w4+x2,h4+y2,w5+x2,h5+y2,w6+x2,h6+y2,w7+x2,h7+y2,r2,1);
     fractal(w1, h1+y4, w2,h2+y4,w3,h3+y4,w4,h4+y4,w5,h5+y4,w6,h6+y4,w7,h7+y4,r2,1);
     fractal(w1, h1-y4, w2,h2-y4,w3,h3-y4,w4,h4-y4,w5,h5-y4,w6,h6-y4,w7,h7-y4,r2,1);
